...
import net.preea.apericraft.blocks.Corn_Block;
import net.preea.apericraft.blocks.Green_Infused_Soil;
...
public static void earth(){
	ABlocks.Green_Infused_Soil = new Green_Infused_Soil().setBlockName("GreenInfusedSoil");
 	GameRegistry.registerBlock(ABlocks.Green_Infused_Soil, "GreenInfusedSoil");

}
public static void Crops(){
	ABlocks.Corn_Block = new Corn_Block().setBlockName("Corn");
 	GameRegistry.registerBlock(ABlocks.Corn_Block, "CornBlock");
}
}
